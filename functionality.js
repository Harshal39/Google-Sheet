let activeCellId = null;// Defines the currently active cell.

//Using Query selectors for class and getElementbyId for Id
const activeCellElement = document.getElementById("active-cell");//DOM
...
function applyStyles(styles) {
    ...
    activeCell.style.fontWeight = styles.isBold ? "600" : "400";//Ternary Operators
    activeCell.style.fontFamily = styles.fontFamily;
    activeCell.style.fontSize = styles.fontSize + "px";//Concatenation
